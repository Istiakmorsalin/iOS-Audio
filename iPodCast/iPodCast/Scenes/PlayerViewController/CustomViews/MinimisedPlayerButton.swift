...
@IBDesignable public class SVGPlayButton: UIButton {
    ...
    @IBInspectable public var progressTrackColor: UIColor = UIColor.red
    
    @IBInspectable public var playColor: UIColor = .white
    
    @IBInspectable public var pauseColor: UIColor = .white
    ...
    private func sharedInit() {
        self.addTarget(self, action: #selector(touchUpInsideHandler), for: UIControl.Event.touchUpInside)
    }
    ...
    private func animate() {
        let t1 = CGAffineTransform(scaleX: 0.95, y: 0.95)
        self.transform = t1
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.425, initialSpringVelocity: 0.9, options: .beginFromCurrentState, animations: { () -> Void in
