...
class IstiakPlayerManager {
    ...
    public var state: IstiakPlayerState {
        return player.state
    }
...
//        }
    ...
    public func getCurrentPlaybackSpeed() -> Float {
        return player.playebackRate;
    }
    
    public func changePlaybackSpeed(atRate: Float) {
        player.changeRate(atRate: atRate)
    }
    ...
    var outputType: IstiakPlayerType {
        return player.outputType
    }
}
